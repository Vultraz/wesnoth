...
public:
	 ...
	 */
	widget_ptr_t swap_child(const std::string& id,
						widget_ptr_t w,
						const bool recurse,
...
private:
	...
	public:
		...
		/** Takes ownership of the given widget. */
		void set_widget(widget_ptr_t widget)
		{
			widget_ = widget;
		}
...
using grid_ptr_t = std::shared_ptr<grid>;
 ...
 */
void set_single_child(grid& grid, widget_ptr_t widget);
